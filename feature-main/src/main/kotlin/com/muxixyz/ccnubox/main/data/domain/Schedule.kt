...
fun Schedule.asDatabaseModel(): DatabaseSchedule {
    return let {
        DatabaseSchedule(
            ...
            startTime = if (it.startTime == null) null else it.startTime!!.timeInMillis,
            endTime = if (it.endTime == null) null else it.endTime!!.timeInMillis,
            ...
            createdAt = it.createdAt.timeInMillis,
            updatedAt = if (it.updatedAt == null) null else it.updatedAt!!.timeInMillis,
            sortKey = it.sortKey
        )
    }
}
